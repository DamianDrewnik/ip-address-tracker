...
L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
    ...
    tileSize: 512,
    zoomOffset: -1,
    accessToken: 'pk.eyJ1IjoiZGFtaWFuLWRyZXduaWsiLCJhIjoiY2t1am9nZTJoMGx4ajJycnZkZXZodGcwaiJ9.i-w9v3peS9K18GW8JRtKyA'
}).addTo(mymap);
...
form.addEventListener('submit', async function(e){
  ...
  const res = await axios.get(`https://geo.ipify.org/api/v2/country,city?apiKey=at_li3f8R0tOlJuEDDN3GYZUg3ivU03j&domain=${searchTerm}&ipAddress=${searchTerm}`)
